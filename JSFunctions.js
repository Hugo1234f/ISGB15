...
function eggxecuteMove(e) {
    ...
    if(e.target.tagName === "TD" && e.target.innerText === '') {
        ...
        if(oGameData.currentPlayer === oGameData.playerOne) {
            ...
            document.getElementsByClassName("jumbotron")[0].getElementsByTagName("h1")[0].innerText = oGameData.nickNamePlayerTwo + '(O)';
        }else {
            e.target.style.backgroundColor = oGameData.colorPlayerTwo;
            e.target.innerText = oGameData.playerTwo;
            oGameData.currentPlayer = oGameData.playerOne;
            document.getElementsByClassName("jumbotron")[0].getElementsByTagName("h1")[0].innerText = oGameData.nickNamePlayerOne + '(X)';
        }
        ...
        if(result === 1 || result === 2 || result === 3) {
            ...
            if(result === 1) {
                document.getElementsByClassName("jumbotron")[0].getElementsByTagName("h1")[0].innerText = "Spelare " + oGameData.nickNamePlayerOne +" vann";
            }else if (result === 2) {
                document.getElementsByClassName("jumbotron")[0].getElementsByTagName("h1")[0].innerText = "Spelare " + oGameData.nickNamePlayerTwo + " vann";
            }else {
                document.getElementsByClassName("jumbotron")[0].getElementsByTagName("h1")[0].innerText = "Oavgjort";
            }
